...
const characters = pgTable("characters", {
  ...
  heritageId: uuid("heritage").references(() => heritages.id).notNull(),
  cultureId: uuid("culture").references(() => cultures.id).notNull(),
  archetypeId: uuid("archetype").references(() => archetypes.id).notNull(),
  secondaryArchetypeId: uuid("secondary_archetype").references(() => archetypes.id),
  body: integer("body").notNull(),
