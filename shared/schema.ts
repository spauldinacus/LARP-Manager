...
export const ARCHETYPES = [
  {
    id: 'adviser',
    name: 'Adviser',
    primarySkills: ['Alertness', 'Courage', 'Hide', 'Intimidation', 'Lore (History)', 'Plead for Mercy', 'Quick Search', 'Socialite', 'Taunt', 'Withdraw'],
    secondarySkills: ['Backstab', 'Dodge', 'Weapon Focus (Small)'],
  },
  {
    id: 'apothecary',
    name: 'Apothecary',
    primarySkills: ['Alchemy', 'Alchemy Master', 'Blinding', 'First Aid', 'Herbalism', 'Mercantile', 'Scribe', 'Wealth'],
    secondarySkills: ['Plead for Mercy', 'Trader', 'Weapon Proficiency (Staff)'],
  },
  {
    id: 'archer',
    name: 'Archer',
    primarySkills: ['Armor Training (Light)', 'Dexterity Armor', 'Dodge', 'Hide', 'Knockback', 'Marksmanship', 'Rapidfire', 'Weapon Proficiency (Bow or Crossbow)', 'Weapon Focus (Bow or Crossbow)', 'Withdraw'],
    secondarySkills: ['Hunting', 'Stealth', 'Trapper'],
  },
  {
    id: 'berserker',
    name: 'Berserker',
    primarySkills: ['Alertness', 'Ambidexterity', 'Brutal Blow', 'Courage', 'Frenzy', 'Intercept', 'Intimidation', 'Knockback', 'Weapon Proficiency (Medium, Large)', 'Weapon Focus (Unarmed, Small, Medium, Large)'],
    secondarySkills: ['Armor Training (Light)', 'Dexterity Armor', 'Shield'],
  },
  {
    id: 'brute',
    name: 'Brute',
    primarySkills: ['Brutal Blow', 'Courage', 'Hamstring', 'Intercept', 'Iron Will', 'Knockback', 'Power Through', 'Toughness', 'Weapon Proficiency (Medium, Large, or Polearm)', 'Weapon Focus (Medium, Large, or Polearm)'],
    secondarySkills: ['Blinding', 'Dexterity Armor', 'Lumberjack'],
  },
  {
    id: 'chef',
    name: 'Chef',
  ...
  },
  {
    id: 'skirmisher',
    name: 'Skirmisher',
    primarySkills: ['Ambidexterity', 'Armor Training (Light)', 'Dexterity Armor', 'Disarm', 'Dodge', 'Intercept', 'Parry', 'Piercing Strike', 'Riposte', 'Weapon Proficiency (Medium, Staff, or Polearm)', 'Weapon Focus (Small, Medium, Staff, or Polearm)'],
    secondarySkills: ['Brutal Blow', 'Hamstring', 'Taunt'],
  },
  {
    id: 'slayer',
    name: 'Slayer',
    primarySkills: ['Armor Training (Light)', 'Armor Training (Medium)', 'Courage', 'Hide', 'Intercept', 'Iron Will', 'Lore (Monster)', 'Parry', 'Weapon Focus (Medium, Large, Polearm, or Thrown)', 'Weapon Proficiency (Medium, Large, Polearm, or Thrown)'],
